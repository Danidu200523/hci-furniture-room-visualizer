...
import FurnitureStyleSelector from "../components/FurnitureStyleSelector";
  ...
  const handleMouseMove = (e) => {
    ...
    setObjects((prev) =>
      prev.map((obj) => {
        ...
        const maxX =
          roomBounds.startX + roomBounds.roomWidth - obj.width;

        const maxY =
          roomBounds.startY + roomBounds.roomHeight - obj.height;
